      ...
      <div className="mx-auto max-w-container-md px-6 py-12">
        ...
        <div className="mt-8 border-t border-muted-foreground/20 pt-8">
          <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
            ...
            <div className="text-sm">© {new Date().getFullYear()} <a className="size-8 text-violet-800"  href="https://www.mulverse.com/"> Hinsell </a>Trading Company, a <a className="size-8 text-violet-800"  href="https://www.mulverse.com/">Mulverse</a> company.</div>
          </div>
        </div>
      </div>
    </footer>
