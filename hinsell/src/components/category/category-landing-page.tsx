    ...
    <div className="mx-auto w-full md:max-w-7xl">
      ...
      {products.length > 0 && (
        <div className="py-8">
          ...
          {}
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-4">
            {displayedProducts.map((product) => (
              <ItemCard item={product} key={product.id} className="h-full" />
            ))}
          </div>
