 ...
 */
export function useLicenseTypesList(search?: string, ordering?: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number }) {
  return useQuery({
 ...
 */
export function useSuspenseLicenseTypesList(search?: string, ordering?: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number }) {
 ...
 */
export function useLicenseTypesRead(id: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number }) {
  return useQuery({
 ...
 */
export function useSuspenseLicenseTypesRead(id: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number }) {
  return useSuspenseQuery({
    queryKey: ['licenseTypesRead', id],
    queryFn: async () => {
      const result = await licenseTypesRead({ params: { path: { id } } })
