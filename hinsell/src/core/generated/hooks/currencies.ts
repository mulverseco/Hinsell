 ...
 */
export function useCurrenciesList(search?: string, ordering?: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number; initialData?: z.infer<typeof CurrenciesListResponseSchema> }) {
  const { initialData, ...restOptions } = options ?? {}

  return useQuery({
    queryKey: ['currenciesList', search, ordering],
    queryFn: async ({ signal }) => {
      try {
        const result = await currenciesList({ params: { query: { search, ordering } } })
        return result
      } catch (error) {
 ...
 */
export function useSuspenseCurrenciesList(search?: string, ordering?: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number; initialData?: z.infer<typeof CurrenciesListResponseSchema> }) {
  const { initialData, ...restOptions } = options ?? {}
 ...
 */
export function useCurrenciesRead(id: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number; initialData?: z.infer<typeof CurrenciesReadResponseSchema> }) {
  const { initialData, ...restOptions } = options ?? {}
 ...
 */
export function useSuspenseCurrenciesRead(id: string, options?: { enabled?: boolean; suspense?: boolean; refetchInterval?: number; initialData?: z.infer<typeof CurrenciesReadResponseSchema> }) {
  const { initialData, ...restOptions } = options ?? {}
