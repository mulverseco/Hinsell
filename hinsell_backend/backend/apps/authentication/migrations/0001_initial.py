    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, default=apps.core_apps.utils.get_default_employee_code, max_length=50, null=True, unique=True, verbose_name='Employee Code')),
